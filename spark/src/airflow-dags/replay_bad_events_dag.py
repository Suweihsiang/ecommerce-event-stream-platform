...
with DAG(
    dag_id="replay_bad_events",
    default_args=default_args,
    start_date=pendulum.datetime(2026, 5, 9, 3, 0, tz=local_tz),
    schedule=None,
    catchup=False,
    tags=["spark", "iceberg", "replay", "data-quality"],
) as dag:

    replay_bad_events = KubernetesPodOperator(
        task_id="replay_bad_events",
        name="replay-bad-events",
        namespace="spark",
        ...
        arguments=[
            ...
            "local:///opt/spark/apps/replay-bad-events.py",
        ],
        get_logs=True,
